...
variable "data_volume_name" {
  type        = string
  description = "Name of the Cinder volume used for persistent BlueMap web data"
  default     = "bluemap-data"
}

variable "data_volume_size_gb" {
  type        = number
  description = "Size of the persistent BlueMap data volume in GiB"
  default     = 20
